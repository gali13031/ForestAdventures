...
public class WinningActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            LinearLayout linearLayout = findViewById(R.id.winning);
            linearLayout.setBackground(getResources().getDrawable(R.drawable.victory_heb));
        }

        gifFireworks = findViewById(R.id.fireworks_gif);

        Glide
                .with(this)
                .load(R.drawable.fireworks)
                .asGif()
                .placeholder(R.drawable.fireworks)
                .crossFade()
                .into(gifFireworks);
        ...
        scoreTv.setText(getResources().getString(R.string.scoreResult_str) + " " + score);
        ...
        okBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!nameEt.getText().toString().isEmpty()) // if entered a name
                {
                    ...
                    Intent intent = new Intent(WinningActivity.this, Scoreboard.class);
                    intent.putExtra("name", name);
                    intent.putExtra("score", score);
                    startActivity(intent);
                }

                else { // didnt entered a name - make a toast
                    Toast.makeText(WinningActivity.this, getResources().getString(R.string.entername_str), Toast.LENGTH_LONG).show();
                }
            }
        });
    }
